...
get_parks <- function(state = 'all', park_code = NULL, api_key = my_api_key) { 
    ...
    if(!is.null(park_code)) {
       ...
       url <- paste0(base_url,'&park=', state) 
    }
    ...
    out <- fromJSON(rawToChar(api_call))
